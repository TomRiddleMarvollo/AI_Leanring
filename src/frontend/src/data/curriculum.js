// Static curriculum content for the "Bài học" tab.
// Kept as plain data (no backend/AI dependency) so it always renders,
// independent of scraping/Gemini/Ollama availability.
